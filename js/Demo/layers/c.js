...
addLayer("c", {
        ...
        milestones: {
            ...
            1: {requirementDescription: "4 根棒棒糖",
                ...
                effectDescription: "你可以切换哔哔和嘟嘟（它们什么都不做）",
                toggles: [
        ...
        upgrades: {
            ...
            12: {
                description: "点数生成速度根据你未花费的棒棒糖数量加快。",
                cost: new Decimal(1),
            ...
            13: {
                ...
                fullDisplay: "只有点数少于 7 时才能购买，并且给你 7 个更多点数。解锁一个秘密子标签页。"
            },
            22: {
                title: "这个升级不存在",
                description: "或者它存在？",
        ...
        buyables: {
            ...
            respecMessage: "你确定吗？重置这些不会带来太大作用。",
            11: {
                ...
                display() { // Everything else displayed in the buyable button after the title
                    ...
                    return "成本: " + format(data.cost) + " 根棒棒糖\n\
                    数量: " + player[this.layer].buyables[this.id] + "/4\n\
                    增加 + " + format(data.effect.first) + " 个东西并将东西乘以 " + format(data.effect.second)
                },
        ...
        tabFormat: {
            "main tab": {
                ...
                content:
                    ...
                    ["display-text", "给你的点数命名！"],
                    ["text-input", "thingy"],
                    ["display-text",
                        function() {return '我有 ' + format(player.points) + ' 个' + player[this.layer].thingy + ' 点数！'},
            ...
            thingies: {
                ...
                content:[ 
                    ...
                    ["row", [
                        ...
                        ["display-text", function() {return "哔哔"}], "blank", ["v-line", "200px"],
                        ["column", [
            ...
            jail: {
                ...
                content: [
                    ...
                    "blank", ["display-text", "这是监狱因为\"条条框框\"！太搞笑了！哈哈！"],["tree", testTree], 
                ],
            },
            illuminati: {
