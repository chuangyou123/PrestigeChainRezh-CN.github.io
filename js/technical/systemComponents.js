var systemComponents = {
    ...
    'info-tab': {
        ...
        <br>
        模组树 <a v-bind:href="'https://github.com/Acamaeda/The-Modding-Tree/blob/master/changelog.md'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >{{TMT_VERSION.tmtNum}}</a> 由 Acamaeda 和 FlamemasterNXF 制作
        <br>
    ...
    'options-tab': {
        ...
        <table>
            ...
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">单页签模式: {{ options.forceOneTab?"始终":"自动" }}</button></td>
